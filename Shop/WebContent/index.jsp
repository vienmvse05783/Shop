...
<link rel='stylesheet' type='text/css' href='//fonts.googleapis.com/css?family=Open+Sans:400,300,600&amp;subset=cyrillic,latin'>
    ...
    <link rel="stylesheet" href="static/css/footers/footer-v4.css">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img id="logo-header" src="static/img/logo.png" alt="Logo">
                    </a>
                </div>
                    ...
                    <ul class="list-inline shop-badge badge-lists badge-icons pull-right">
                        <li>
                            ...
                            <ul class="list-unstyled badge-open mCustomScrollbar" data-mcs-theme="minimal-dark">
                                <li>
                                    <img src="static/img/thumb/05.jpg" alt="">
                                ...
                                <li>
                                    <img src="static/img/thumb/02.jpg" alt="">
                                    <button type="button" class="close">×</button>
                                    <div class="overflow-h">
                                        <span>Black Glasses</span>
                                        <small>1 x $400.00</small>
                                ...
                                <li>
                                    <img src="static/img/thumb/03.jpg" alt="">
                                    <button type="button" class="close">×</button>
                                    <div class="overflow-h">
                                        <span>Black Glasses</span>
                                        <small>1 x $400.00</small>
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-sm-4 col-xs-4 md-margin-bottom-30">
                                                    <a href="#"><img class="product-offers img-responsive" src="static/img/blog/01.jpg" alt=""></a>
                                                </div>
                                                <div class="col-md-3 col-sm-4 col-xs-4 sm-margin-bottom-30">
                                                    <a href="#"><img class="product-offers img-responsive" src="static/img/blog/02.jpg" alt=""></a>
                                                </div>
                                                <div class="col-md-3 col-sm-4 col-xs-4">
                                                    <a href="#"><img class="product-offers img-responsive" src="static/img/blog/03.jpg" alt=""></a>
                                                </div>
                                            </div><!--/end row-->
                                        </div><!--/end container-->
        ...
        <div class="tp-banner">
            <ul>
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 1">
                    <!-- MAIN IMAGE -->
                    <img src="static/img/1.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 2">
                    <!-- MAIN IMAGE -->
                    <img src="static/img/5.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 3">
                    <!-- MAIN IMAGE -->
                    <img src="static/img/3.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="right top" data-bgrepeat="no-repeat">
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 4">
                    <!-- MAIN IMAGE -->
                    <img src="static/img/2.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 5">
                    <!-- MAIN IMAGE -->
                    <img src="static/img/4.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="right top" data-bgrepeat="no-repeat">
    ...
    <div class="container content-md">
            ...
            <ul class="list-inline owl-slider">
                <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.html"><img class="full-width img-responsive" src="static/img/blog/09.jpg" alt=""></a>
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.html"><img class="full-width img-responsive" src="static/img/blog/26.jpg" alt=""></a>
                        <a class="product-review" href="shop-ui-inner.html">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                    </div> 
                    <div class="product-description product-description-brd">
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.html"><img class="full-width img-responsive" src="static/img/blog/11.jpg" alt=""></a>
                        <a class="product-review" href="shop-ui-inner.html">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.html"><img class="full-width img-responsive" src="static/img/blog/12.jpg" alt=""></a>
                        <a class="product-review" href="shop-ui-inner.html">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.html"><img class="full-width img-responsive" src="static/img/blog/10.jpg" alt=""></a>
                        <a class="product-review" href="shop-ui-inner.html">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                    </div> 
                    <div class="product-description product-description-brd">
        ...
        <div class="row illustration-v2">
            <div class="col-md-3 col-sm-6 md-margin-bottom-30">
                <div class="product-img">
                    <a href="shop-ui-inner.html"><img class="full-width img-responsive" src="static/img/blog/25.jpg" alt=""></a>
                    <a class="product-review" href="shop-ui-inner.html">Quick review</a>
                    <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                </div>
                <div class="product-description product-description-brd">
        ...
        <div class="row illustration-v4 margin-bottom-40">
            <div class="col-md-4">
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="static/img/thumb/08.jpg" alt="">
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="static/img/thumb/09.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="static/img/thumb/03.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="static/img/thumb/02.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="static/img/thumb/10.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="static/img/thumb/06.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
            ...
            <div class="col-md-4 padding">
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="static/img/thumb/07.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="static/img/thumb/04.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="static/img/thumb/05.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
    ...
    <div class="container content">
        ...
        <ul class="list-inline owl-slider-v2">
            <li class="item first-child">
                <img src="static/img/clients/07.png" alt="">
            </li>
            <li class="item">
                <img src="static/img/clients/08.png" alt="">
            </li>
            <li class="item">
                <img src="static/img/clients/10.png" alt="">
            </li>
            <li class="item">
                <img src="static/img/clients/11.png" alt="">
            </li>
            <li class="item">
                <img src="static/img/clients/09.png" alt="">
            </li>
            <li class="item">
                <img src="static/img/clients/12.png" alt="">
            </li>
            <li class="item">
                <img src="static/img/clients/07.png" alt="">
            </li>
...
<script src="static/plugins/scrollbar/js/jquery.mCustomScrollbar.concat.min.js"></script>
...
<!-- JS Page Level -->
<script src="static/js/shop.app.js"></script>
<script src="static/js/plugins/owl-carousel.js"></script>
<script src="static/js/plugins/revolution-slider.js"></script>
<script>
