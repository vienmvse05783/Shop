            ...
            <div class="row">
                <div class="col-md-7 md-margin-bottom-50">
                    ...
                    <div class="members-number">
                        ...
                        <img class="img-responsive" src="http://localhost:8080/Shop/static/img/map.png" alt="">
                    </div>    
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 md-margin-bottom-40">
                        <a href="index.html"><img class="footer-logo" src="http://localhost:8080/Shop/static/img/logo-2.png" alt=""></a>
...
<script src="http://localhost:8080/Shop/static/js/forms/page_registration.js"></script>
<script>
